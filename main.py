...
def main():
    ...
    #multipleCrossValidation(df, 900, 5, 5, 0.001, 0.05)
...
def multipleCrossValidation(df, sample_size=1600, k=5, laps=15, start=0.001, end=0.05):
